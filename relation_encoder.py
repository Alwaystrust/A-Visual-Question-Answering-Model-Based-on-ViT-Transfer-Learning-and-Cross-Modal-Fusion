...
from attention import GAttNet as GAT
from language_model import QuestionSelfAttention
...
class ImplicitRelationEncoder(nn.Module):
    ...
    def forward(self, v, position_embedding, q):
        ...
        for i in range(self.num_steps):
            v_cat_q = q_expand_v_cat(q, imp_v, mask=True) #v”ÎqµƒºÚµ•¡¨Ω”
            imp_v_rel = self.implicit_relation.forward(v_cat_q,imp_adj_mat,position_embedding) #“˛ Ωπÿœµv-q
