...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, dictionary, data_name, method, dataroot='data'):
        ...
        '''
        assert data_name in ['maskrcnn','revisit','fasterrcnn','fasterrcnn_my','fasterrcnn_my2','solo_faster','my_solo_data','my_solo_data2']
        print('loading %s features from h5 file'%(data_name))

        path = os.path.join(dataroot,data_name)
